  ...
  protected render(): void {
    this.shadow.innerHTML = `<style>@import '/src/styles/tokens.css';
      ...
      .stats-strip { margin-top:auto; display:flex; justify-content:center; gap:26px; padding:18px 40px 8px;
               border-top:1px solid var(--border); flex-wrap:wrap; font-family:var(--font-mono); font-size:13px; color:var(--accent); letter-spacing:.06em;}
  ...
  private _renderChoices(): string {
    ...
    return `
      <div class="choice-view">
        ...
        <div class="cta-grid">
          <button class="cta-card cta-card-free" data-choice="free">
            <picture class="cta-icon">
              <source srcset="../../public/images/mode_libre.gif" type="image/webp">
          ...
          <button class="cta-card cta-card-challenges" data-choice="challenges">
            <picture class="cta-icon">
              <source srcset="../../public/images/tutos.gif" type="image/webp">
              <img src="/images/pencil.gif" alt="✏" width="32" height="32">
            </picture>
          ...
          <button class="cta-card cta-card-pong locked-hint" data-choice="pong">
            <picture class="cta-icon">
              <source srcset="../../public/images/defis.gif" type="image/webp">
              <img src="/images/pencil.gif" alt="✏" width="32" height="32">
            </picture>
        ...
        <div class="stats-strip">
          ...
          <span><strong>Une machine, des contraintes, ton cerveau, et rien d'autres.</strong></span>
