...
// 96 caractères ASCII $20–$7F, 8 octets chacun (8 lignes × 8 pixels, bit7 = pixel gauche)
...
const CHARSET_JS = new Uint8Array([
  ...
  // $25 %
  0xC4,0xC8,0x10,0x20,0x46,0x8C,0x0C,0x00,
  // $26 &
  0x70,0xD8,0xD8,0x70,0xDA,0xCC,0x74,0x00,
  // $27 '
  ...
  // $2A *
  0x00,0x28,0x10,0xFE,0x10,0x28,0x00,0x00,
  // $2B +
  ...
  // $30 0
  0x78,0xCC,0xDC,0xD6,0xE6,0xC6,0x78,0x00,
  // $31 1
  0x30,0x70,0x30,0x30,0x30,0x30,0xFC,0x00,
  // $32 2
  0x78,0xCC,0x0C,0x18,0x30,0x60,0xFC,0x00,
  // $33 3
  0xFC,0x0C,0x18,0x38,0x0C,0xCC,0x78,0x00,
  // $34 4
  ...
  // $37 7
  0xFC,0x0C,0x18,0x30,0x60,0x60,0x60,0x00,
  // $38 8
  ...
  // $3C <
  0x1C,0x30,0x60,0xC0,0x60,0x30,0x1C,0x00,
  // $3D =
  ...
  // $40 @
  0x78,0xCC,0xDC,0xDC,0xDE,0xC0,0x7C,0x00,
  // $41 A
  ...
  // $4D M
  0xCC,0xFC,0xFC,0xDC,0xCC,0xCC,0xCC,0x00,
  // $4E N
  ...
  // $51 Q
  0x78,0xCC,0xCC,0xCC,0xDC,0xD8,0x7A,0x00,
  // $52 R
  ...
  // $57 W
  0xCC,0xCC,0xCC,0xDC,0xFC,0xFC,0xCC,0x00,
  // $58 X
  ...
  // $66 f
  0x38,0x6C,0x60,0xF0,0x60,0x60,0x60,0x00,
  // $67 g
  0x00,0x7C,0xCC,0xCC,0x7C,0x0C,0x78,0x00,
  // $68 h
  0xC0,0xC0,0xF8,0xCC,0xCC,0xCC,0xCC,0x00,
  // $69 i
  0x30,0x00,0x70,0x30,0x30,0x30,0xFC,0x00,
  // $6A j
  0x0C,0x00,0x38,0x0C,0x0C,0xCC,0x78,0x00,
  // $6B k
  0xC0,0xC0,0xCC,0xD8,0xF0,0xD8,0xCC,0x00,
  // $6C l
  0x70,0x30,0x30,0x30,0x30,0x30,0xFC,0x00,
  // $6D m
  0x00,0x00,0xD8,0xFC,0xFC,0xDC,0xCC,0x00,
  // $6E n
  0x00,0x00,0xF8,0xCC,0xCC,0xCC,0xCC,0x00,
  // $6F o
  0x00,0x00,0x78,0xCC,0xCC,0xCC,0x78,0x00,
  // $70 p
  0x00,0xF8,0xCC,0xCC,0xF8,0xC0,0xC0,0x00,
  // $71 q
  0x00,0x7C,0xCC,0xCC,0x7C,0x0C,0x0C,0x00,
  // $72 r
  0x00,0x00,0xDC,0xEC,0xC0,0xC0,0xC0,0x00,
  // $73 s
  0x00,0x00,0x7C,0xC0,0x78,0x0C,0xF8,0x00,
  // $74 t
  0x60,0x60,0xF0,0x60,0x60,0x6C,0x38,0x00,
  // $75 u
  0x00,0x00,0xCC,0xCC,0xCC,0xCC,0x7C,0x00,
  // $76 v
  0x00,0x00,0xCC,0xCC,0xCC,0x78,0x30,0x00,
  // $77 w
  0x00,0x00,0xCC,0xCC,0xDC,0xFC,0x6C,0x00,
  // $78 x
  0x00,0x00,0xCC,0x78,0x30,0x78,0xCC,0x00,
  // $79 y
  0x00,0xCC,0xCC,0xCC,0x7C,0x0C,0x78,0x00,
  // $7A z
...
export class ChuckDisplay extends ChuckComponent {
  ...
  private _renderText(ram: Uint8Array): void {
    for (let row = 0; row < TEXT_ROWS; row++) {
      for (let col = 0; col < TEXT_COLS; col++) {
        const textAddr = VRAM_TEXT + row * TEXT_COLS + col;
        const attrAddr = VRAM_ATTR + row * TEXT_COLS + col;
  ...
  /**
   * Affiche un caractère 8×8 à la position pixel (px, py).
